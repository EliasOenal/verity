...
export const Settings = {
    ...
    RECONNECT_MAX_FIBONACCI_FACTOR: 20, // increase RETRY and RECONNECT intervals on each failure according to a Fibonacci factor, but no more than 20 times (i.e. a maximum of 6765 times the initial interval)
