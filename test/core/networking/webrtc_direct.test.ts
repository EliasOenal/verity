...
describe('WebRTC-Direct functionality', () => {
  it('should include webRTC-Direct transport on Node.js', async () => {
    // Only run this test on Node.js as webRTC-Direct is Node.js specific for listening
    if (!isNode) {
  ...
  it('should prefer WebRTC-Direct addresses in addressChange method', async () => {
    if (!isNode) {
      console.log('Skipping WebRTC-Direct address preference test in browser environment');
      return;
    }
  ...
  it('should create valid listen configuration for WebRTC-Direct', () => {
    if (!isNode) {
      console.log('Skipping WebRTC-Direct listen configuration test in browser environment');
      return;
    }
  ...
  it('should configure transports with both webRTC and webRTCDirect', async () => {
    if (!isNode) {
      console.log('Skipping dual transport configuration test in browser environment');
      return;
    }
