...
// AI QA: These AI-generated tests should be integrated in the existing
//   networkManager.libp2p test suite. Verifying required libp2p features
//   are actually configures is a valid test, but does not justify its own
//   test suite.
